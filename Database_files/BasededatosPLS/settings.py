...
ROOT_URLCONF = 'BasededatosPLS.urls'
...
WSGI_APPLICATION = 'BasededatosPLS.wsgi.application'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'miapBBDDpls', 'static')]
